            ...
            for i in tqdm(range(10)):
                ...
                if epoch == 0:
                    ...
                    if temp_time ==0:
                        ...
                        train_bias_augmention_model(args, train_loader, device,task_type,bias_augmention_model,bias_optimizers[client_idx], bias_model =  bias_models[client_idx], unbias_model = model)
