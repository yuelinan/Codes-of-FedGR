            ...
            for i in range(10):
                ...
                if epoch == 0:
                    ...
                    if temp_time ==0:
                        ...
                        train_bias_augmention_model(args, train_loader, device,dataset.task_type,bias_augmention_models[client_idx],bias_optimizers[client_idx], bias_model =  bias_models[client_idx], unbias_model = server_model)
